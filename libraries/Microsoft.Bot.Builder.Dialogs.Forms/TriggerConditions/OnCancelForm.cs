...
{
    /// <summary>
    /// Triggered to when request to Cancel the form.
    /// </summary>
    public class OnCancelForm : OnAssignEntity
    {
        [JsonProperty("$kind")]
        public new const string Kind = "Microsoft.OnCancelForm";

        [JsonConstructor]
        public OnCancelForm(string property = null, string entity = null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
