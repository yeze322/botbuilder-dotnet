...
{
    /// <summary>
    /// Triggered to reset a property to have no value.
    /// </summary>
    public class OnClearProperty : OnAssignEntity
    {
        [JsonProperty("$kind")]
        public new const string Kind = "Microsoft.OnClearProperty";

        [JsonConstructor]
        public OnClearProperty(string property = null, string entity = null, List<Dialog> actions = null, string condition = null, [CallerFilePath] string callerPath = "", [CallerLineNumber] int callerLine = 0)
