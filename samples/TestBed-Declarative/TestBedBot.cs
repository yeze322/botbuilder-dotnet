...
namespace Microsoft.BotBuilderSamples
{
    public class TestBedBot : ActivityHandler
    {
        ...
        {
            this._dialogStateAccessor = conversationState.CreateProperty<DialogState>("RootDialogState");
            this._resourceExplorer = resourceExplorer;

            // auto reload dialogs when file changes
            this._resourceExplorer.Changed += (e, resources) =>
            {
        ...
        private void LoadRootDialogAsync()
        {
            ...
            var resource = this._resourceExplorer.GetResource("RootDialog.dialog");
            _dialogManager = new DialogManager(this._resourceExplorer.LoadType<AdaptiveDialog>(resource));
            _dialogManager.UseResourceExplorer(this._resourceExplorer);
